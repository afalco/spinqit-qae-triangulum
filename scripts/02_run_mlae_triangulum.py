...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        ...
        help=(
            "How the NMR backend reports raw 3-bit strings before canonicalization. "
            "Use calibrate_bit_order.py to determine this value. "
...
def main() -> None:
    ...
    backend = TriangulumBackend(
        TriangulumConfig(
            ...
            reported_order=args.reported_order,
        )
    )
    ...
    run_id = (
        f"triangulum_{slug}_y{args.y:g}_{args.rule}_"
